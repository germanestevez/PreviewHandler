...
begin
  ...
  if FileExists(FFilePath) then
    FormPreview.mmFile.Lines.LoadFromFile(FFilePath);
end;
...
initialization
  ...
  TComObjectFactory.Create(ComServer, TBaseShellExt, IID_EXT_ShellHandler, sExtFile, sAppDescription, ciMultiInstance, tmApartment);
